  ...
  const rows = [
    {
      ...
      desc: 'At CarbonSynq, we believe that sustainability data should be as accurate, accessible, and actionable as financial data. Our vision is a world where every enterprise, regardless of size, has the clarity to thrive in a circular economy.',
      image: visionBg,
      cta: 'SEE OUR VISION',
      reverse: false,
    },
    ...
    },
    {
      ...
      desc: 'CarbonSynq was born from the realization that while the climate crisis was accelerating, the tools to manage it were stuck in the past. Today, we are transforming how leading organizations manage their environmental footprint.',
      image: storyBg,
              ...
              <div className="story-modal-grid">
                ...
                <div className="story-modal-text">
                  ...
                  <p className="story-body">
                    Founded in November 2025, CarbonSynq began with a simple yet profound realization: 
