  ...
  >
    <div className="flex items-start gap-4 md:gap-6 lg:gap-10 group">
      <div className="hidden md:flex flex-col items-center pt-2">
        <div className="w-10 h-10 md:w-12 md:h-12 rounded-[1.25rem] bg-white border border-gray-100 shadow-sm flex items-center justify-center text-green-600 font-bold group-hover:bg-green-600 group-hover:text-white transition-all duration-300">
          {index + 1}
        </div>
        <div className="w-[1px] h-32 lg:h-64 bg-gradient-to-b from-green-100 to-transparent mt-4" />
      </div>
      <div className="flex-1">
        <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 md:mb-6 flex items-center gap-3">
          <span className="md:hidden text-green-600">0{index + 1}.</span>
          {title}
        </h2>
        <div className="bg-white/50 backdrop-blur-sm p-5 md:p-8 lg:p-12 rounded-[1.5rem] lg:rounded-[3rem] border border-gray-100 hover:border-green-200 hover:shadow-xl hover:shadow-green-500/5 transition-all duration-500">
          {children}
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-[#fcfcfc] selection:bg-green-100 text-[#1a1a1a] scroll-smooth">
      ...
      <header className="pt-24 md:pt-32 lg:pt-64 pb-16 md:pb-32 px-6 md:px-10 text-center relative z-10">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-800 max-w-4xl mx-auto font-black leading-relaxed">
          Our commitment to transparency and sustainable growth. Everything you need to know about partnering with CarbonSynq.
        </p>
      </header>

      {/* MAIN CONTENT GRID */}
      <main className="max-w-6xl mx-auto px-6 relative z-10 pb-32 md:pb-64">
        <div className="grid grid-cols-12 gap-8 md:gap-12 lg:gap-20">
          ...
          <aside className="hidden lg:block col-span-3 sticky top-32 h-fit">
            <div className="space-y-8">
              <div className="p-6 md:p-8 lg:p-10 rounded-[1.5rem] lg:rounded-[2.5rem] bg-white border border-gray-100 shadow-sm">
          ...
          <div className="col-span-12 lg:col-span-9 space-y-4">
            <Section id="acceptance" title="Acceptance of terms" index={0}>
              <p className="text-gray-600 leading-relaxed font-medium mb-4">
                By initializing your CarbonSynq account or deploying our tracking SDKs, you agree to comply with these terms, all applicable environmental laws, and international reporting standards.
              </p>
            ...
            <Section id="governance" title="Account Governance" index={2}>
              <p className="text-gray-600 leading-relaxed font-medium mb-6">
                You are responsible for maintaining the confidentiality of your ESG credentials. CarbonSynq utilizes <strong>AES-256 encryption</strong> for all data at rest.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 border border-gray-100 text-xs md:text-sm font-bold text-gray-500">
            ...
            <Section id="ai-ethics" title="AI Usage & Ethical Boundaries" index={3}>
              <p className="text-gray-600 leading-relaxed font-medium">
                You agree to use the CarbonSynq AI engine solely for legitimate carbon footprint analysis. Reverse-engineering our <strong>CarbonPulse™</strong> algorithms or using our data to train competing models is strictly prohibited. AI-generated insights are provided as recommendations and should be verified by sustainability professionals.
              </p>
            </Section>

            <Section id="proprietary" title="Content & Carbon Credits" index={4}>
              <p className="text-gray-600 leading-relaxed font-medium mb-6">
                All reporting templates, ESG frameworks, and dynamic visualizations generated by CarbonSynq are the sole intellectual property of the Company.
              </p>
            ...
            <Section id="security" title="Security & Data Governance" index={5}>
              <p className="text-gray-600 leading-relaxed font-medium mb-4">
                CarbonSynq adheres to <strong>SOC2 and GDPR</strong> compliance standards. Your operational data is siloed and never utilized for cross-tenant analytics without anonymization.
              </p>
              <p className="text-gray-600 leading-relaxed font-medium">
            ...
            <Section id="contact" title="Contact Us" index={10}>
              <div className="bg-gray-900 rounded-[1.5rem] lg:rounded-[2.5rem] p-6 md:p-10 lg:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 group shadow-2xl shadow-green-900/20">
                <div className="max-w-xs text-center md:text-left">
                  <Mail className="text-green-400 mb-4 mx-auto md:mx-0" size={28} />
                  <h4 className="text-xl md:text-2xl font-bold mb-2">Legal Inquiries</h4>
                  ...
                  {legalFormStatus === 'success' ? (
                    ...
                    <>
                      <input 
                        ...
                        required 
                        className="w-full bg-white/10 border border-white/20 px-4 md:px-6 py-3 md:py-4 rounded-2xl font-bold text-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all placeholder:text-gray-400 text-sm"
                      />
                      <button 
                        disabled={legalFormStatus === 'submitting'}
                        type="submit"
                        className="w-full sm:w-auto bg-white text-gray-900 px-6 md:px-8 py-3 md:py-4 rounded-2xl font-bold hover:bg-green-600 hover:text-white transition-all duration-300 shadow-xl whitespace-nowrap active:scale-95 disabled:opacity-50 text-sm"
                      >
