...
export default function BookDemoPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 sm:p-8 bg-[#f4fdf8] relative font-sans">
      <div className="w-full max-w-[1150px] bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(5,150,105,0.1)] flex flex-col md:flex-row overflow-hidden border border-green-100 relative z-10">
        
        {/* Left Column: Event Card */}
        <div className="w-full md:w-[460px] p-8 md:p-12 border-b md:border-b-0 md:border-r border-gray-100 flex flex-col shrink-0 bg-white">
